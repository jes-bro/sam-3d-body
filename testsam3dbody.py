...
keypoints_3d_absolute_frame = outputs[0]["pred_keypoints_3d"] + outputs[0]["pred_cam_t"][:, None, :] # understand this to make sure this is right 
...
print(keypoints_3d) # these don't look like theyre in the pixel coord space. maybe it doesn't need to be if i fix and do the IMAGPose thing?
